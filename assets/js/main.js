...
/**
 * Exercice 2
 * @desc Créer 5 boutons et un rectangle bleu de 100px par 100px au centre de 
...
btnHideRect.addEventListener("click", function() {
    // alors on défini la propriété CSS display à none
...
btnShowRect.addEventListener("click", function() {
    ...
    // Attention, j'ai mis "flex" car j'ai utilisé les flexbox pour son positionnement
    // vous pouvez tout à fait utiliser "block" par exemple 
}); 
